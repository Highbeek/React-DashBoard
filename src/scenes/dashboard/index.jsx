      ...
      >
        ...
        >
          <StatBox
            ...
            icon={
              <EmailIcon
                sx={{ color: colors.greenAcent[600], fontSize: "26px" }}
              />
            }
          />
        </Box>
            ...
            <Box>
              <IconButton>
                <DownloadOutlinedIcon
                  sx={{ fontSize: "26px", color: colors.greenAcent[500] }}
                />
              </IconButton>
            </Box>
          </Box>
        ...
        >
          ...
          {mockTransactions.map((transaction, i) => (
            ...
            >
              ...
              <Box
                backgroundColor={colors.greenAcent[500]}
                p="5px 10px"
                borderRadius="4px"
              >
                ${transaction.cost}
